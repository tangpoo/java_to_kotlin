...
import travelator.opentosealed.calendar.Alarm
import travelator.opentosealed.calendar.Calendar
import travelator.opentosealed.calendar.CalendarEvent
...
fun ItineraryItem.toCalendarEvent(): CalendarEvent? =
    when (this) {
